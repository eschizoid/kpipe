...
///
/// * `PAUSE` - Temporarily stops consumption from assigned partitions
/// * `RESUME` - Restarts consumption after being paused
/// * `CLOSE` - Terminates the consumer and releases resources
