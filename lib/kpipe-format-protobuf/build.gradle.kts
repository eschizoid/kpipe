...
publishing {
  publications {
    create<MavenPublication>("maven") {
      ...
      artifactId = "kpipe-format-protobuf"
      from(components["java"])

      pom {
        name.set("kpipe-format-protobuf")
        description.set("KPipe Protobuf format support — ProtobufFormat, processors, and console sink")
