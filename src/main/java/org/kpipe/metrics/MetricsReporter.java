 ...
 *
 * <p>Implementations can report metrics to different destinations such as logs, monitoring
 * systems, or dashboards. The core functionality is defined by {@link #reportMetrics()},
 * while lifecycle methods {@link #start()} and {@link #stop()} are provided with default
...
public interface MetricsReporter {
   ...
   *
   * <p>Implementations may use this method to initialize resources,
   * schedule periodic reporting, or connect to external systems.
   ...
   *
   * <p>Implementations may use this method to release resources,
   * cancel scheduled tasks, or disconnect from external systems.
   * Default implementation does nothing.
   */
  default void stop() {}
}